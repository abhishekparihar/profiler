...
abstract public class DbAdapter {
    ...
    protected static ProfileDatabaseHelper dbHelper;
    ...
    final public static void open(Context context) throws SQLException {
        ...
        try {
            int dbVersionName = context.getPackageManager().getPackageInfo(context.getPackageName(), 0).versionCode;

            dbHelper = new ProfileDatabaseHelper(context, dbVersionName);

            db = dbHelper.getWritableDatabase();
        } catch (SQLiteException e) {
        	Log.i("PROFILER", "OrganizationDbAdapter::getWritableDatabase error: " + e.getMessage());
    ...
    public Cursor fetch(long rowId) throws SQLException {
        ...
        Cursor mCursor = db.query(true, dbName, dbColumns, "_id=" + rowId, null, null, null, null, null);
